...
function displayUserData() {
  ...
  for (const key in dummyUserData) {
    const newUeserDataListItemElement = document.createElement("li");
    const outputText = key.toUpperCase() + ": " + dummyUserData[key];
    newUeserDataListItemElement.textContent = outputText;
    outputDataElement.append(newUeserDataListItemElement);
  }
}
